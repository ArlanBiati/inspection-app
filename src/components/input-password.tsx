...
import { TextInput, type TextInputProps, View, TouchableOpacity, Text } from 'react-native'
...
const InputPassword = forwardRef<TextInput, InputPasswordProps>(({ icon, error = '', formProps, inputProps }, ref) => {
        ...
        <View>
          ...
          >
            ...
            <TouchableOpacity onPress={togglePasswordVisibility}>
              <Feather name={isPasswordVisible ? 'eye-off' : 'eye'} size={24} color="gray" className="ml-3" />
            </TouchableOpacity>
          </View>
