...
export default function TabBarButton({ isFocused, routeName, color, label, ...rest }: TabBarButtonProps) {
  ...
  return (
    <PlatformPressable {...rest} className="flex-1 items-center justify-center gap-1">
